      ...
      <v-layout row wrap>
        <v-flex xs12 mb-3>
          <v-card color="transparent" class flat>
            <v-card-text class="pa-0 headline">Pustakawan</v-card-text>
          </v-card>
        </v-flex>
        <v-flex xs12>
          <v-card>
            <v-flex xs12 pa-3>
              <v-layout class="py-0 my-0">
                ...
                <v-flex xs12 md2 offset-md3>
                  <v-btn color="primary" to="/pustakawan/add">Tambah</v-btn>
                </v-flex>
              </v-layout>
            </v-flex>
...
export default {
  ...
  data() {
    return {
      dialog: false,
      headers: [
        { text: "Username", align: "center", sortable: false, value: "user" },
        { text: "Level", align: "center", sortable: false, value: "level" },
        { text: "Nama", align: "center", sortable: false, value: "name" },
        { text: "Ponsel", align: "center", sortable: false, value: "phone" },
